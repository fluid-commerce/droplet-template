...
import { r as reactExports, a as requireReactDom, g as getDefaultExportFromCjs, n as nt } from './embeddable-component-BD9bezsm.js';
import { r as rB, W as Wg } from './Container-mop-J7T8-BpqPaGKG-DiR4tjay.js';
 ...
 */
var gs = re.exports, zn;
function vs() {
  return zn || (zn = 1, (function(f, _) {
    (function(u, p) {
      p(_);
    })(gs, function(u) {
      var p = "1.9.4";
      ...
      var k = Object.create || /* @__PURE__ */ (function() {
        function t() {
        }
        return function(e) {
      ...
      function E(t, e) {
        Object.prototype.hasOwnProperty.call(t, "options") || (t.options = t.options ? k(t.options) : {});
        for (var i in e)
          t.options[i] = e[i];
        return t.options;
      }
      ...
      var Vt = 0;
      function Ut(t) {
        var e = +/* @__PURE__ */ new Date(), i = Math.max(0, 16 - (e - Vt));
        return Vt = e + i, window.setTimeout(t, i);
      }
      var Et = window.requestAnimationFrame || zt("RequestAnimationFrame") || Ut, N = window.cancelAnimationFrame || zt("CancelAnimationFrame") || zt("CancelRequestAnimationFrame") || function(t) {
      ...
      q.extend = function(t) {
        ...
        }, i = e.__super__ = this.prototype, n = k(i);
        n.constructor = e, e.prototype = n;
        for (var o in this)
          Object.prototype.hasOwnProperty.call(this, o) && o !== "prototype" && o !== "__super__" && (e[o] = this[o]);
        return t.statics && d(e, t.statics), t.includes && (Oe(t.includes), d.apply(null, [n].concat(t.includes))), d(n, t), delete n.statics, delete n.includes, n.options && (n.options = i.options ? k(i.options) : {}, d(n.options, t.options)), n._initHooks = [], n.callInitHooks = function() {
      ...
      var Q = {
        ...
        _off: function(t, e, i) {
          ...
          if (this._events && (n = this._events[t], !!n)) {
            ...
            if (r !== false) {
              var a = n[r];
              this._firingCount && (a.fn = I, this._events[t] = n = n.slice()), n.splice(r, 1);
            }
          }
        },
        ...
        listens: function(t, e, i, n) {
          ...
          if (s && s.length && this._listens(t, o, i) !== false)
            return true;
          if (n) {
        ...
        once: function(t, e, i) {
          if (typeof t == "object")
            for (var n in t)
              this._on(n, t[n], e, true);
          else {
            t = rt(t);
            for (var o = 0, s = t.length; o < s; o++)
              this._on(t[o], e, i, true);
          }
          return this;
        },
      ...
      x.prototype = {
        ...
        _trunc: function() {
          return this.x = vi(this.x), this.y = vi(this.y), this;
        },
      ...
      function w(t, e, i) {
        return t instanceof x ? t : $(t) ? new x(t[0], t[1]) : t == null ? t : typeof t == "object" && "x" in t && "y" in t ? new x(t.x, t.y) : new x(t, e, i);
      }
      function A(t, e) {
        if (t)
      ...
      A.prototype = {
        ...
        contains: function(t) {
          var e, i;
          return typeof t[0] == "number" || t instanceof x ? t = w(t) : t = Y(t), t instanceof A ? (e = t.min, i = t.max) : e = i = t, e.x >= this.min.x && i.x <= this.max.x && e.y >= this.min.y && i.y <= this.max.y;
        },
        ...
        equals: function(t) {
          return t ? (t = Y(t), this.min.equals(t.getTopLeft()) && this.max.equals(t.getBottomRight())) : false;
        }
      };
      function Y(t, e) {
      ...
      X.prototype = {
        ...
        extend: function(t) {
          ...
          if (t instanceof z)
            ...
            return t ? this.extend(C(t) || F(t)) : this;
        ...
        // Returns `true` if the rectangle contains the given point.
        contains: function(t) {
          typeof t[0] == "number" || t instanceof z || "lat" in t ? t = C(t) : t = F(t);
          var e = this._southWest, i = this._northEast, n, o;
          return t instanceof X ? (n = t.getSouthWest(), o = t.getNorthEast()) : n = o = t, n.lat >= e.lat && o.lat <= i.lat && n.lng >= e.lng && o.lng <= i.lng;
        },
      ...
      function C(t, e, i) {
        return t instanceof z ? t : $(t) && typeof t[0] != "object" ? t.length === 3 ? new z(t[0], t[1], t[2]) : t.length === 2 ? new z(t[0], t[1]) : null : t == null ? t : typeof t == "object" && "lat" in t ? new z(t.lat, "lng" in t ? t.lng : t.lon, t.alt) : e === void 0 ? null : new z(t, e, i);
      }
      var ct = {
        ...
        wrapLatLng: function(t) {
          var e = this.wrapLng ? tt(t.lng, this.wrapLng, true) : t.lng, i = this.wrapLat ? tt(t.lat, this.wrapLat, true) : t.lat, n = t.alt;
          return new z(i, e, n);
        },
        ...
        wrapLatLngBounds: function(t) {
          ...
          if (n === 0 && o === 0)
            return t;
          var s = t.getSouthWest(), r = t.getNorthEast(), a = new z(s.lat - n, s.lng - o), h = new z(r.lat - n, r.lng - o);
          return new X(a, h);
        }
      }, yt = d({}, ct, {
        wrapLng: [-180, 180],
      ...
      var Be = document.documentElement.style, ue = "ActiveXObject" in window, Dn = ue && !document.addEventListener, Pi = "msLaunchUri" in navigator && !("documentMode" in document), Re = at("webkit"), Li = at("android"), bi = at("android 2") || at("android 3"), Hn = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10), Fn = Li && at("Google") && Hn < 537 && !("AudioNode" in window), Ne = !!window.opera, Ti = !Pi && at("chrome"), Ci = at("gecko") && !Re && !Ne && !ue, Wn = !Ti && at("safari"), Mi = at("phantom"), Si = "OTransition" in Be, Vn = navigator.platform.indexOf("Win") === 0, ki = ue && "transition" in Be, De = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !bi, zi = "MozPerspective" in Be, Un = !window.L_DISABLE_3D && (ki || De || zi) && !Si && !Mi, jt = typeof orientation < "u" || at("mobile"), Gn = jt && Re, qn = jt && De, Ei = !window.PointerEvent && window.MSPointerEvent, Oi = !!(window.PointerEvent || Ei), Zi = "ontouchstart" in window || !!window.TouchEvent, jn = !window.L_NO_TOUCH && (Zi || Oi), Kn = jt && Ne, Yn = jt && Ci, Xn = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1, Jn = (function() {
        var t = false;
        try {
          ...
          window.addEventListener("testPassiveEventSupport", I, e), window.removeEventListener("testPassiveEventSupport", I, e);
        } catch {
        }
        return t;
      })(), $n = (function() {
        return !!document.createElement("canvas").getContext;
      })(), He = !!(document.createElementNS && wi("svg").createSVGRect), Qn = !!He && (function() {
      ...
      var m = {
        ...
        mac: eo,
        linux: io
      }, Ii = m.msPointer ? "MSPointerDown" : "pointerdown", Ai = m.msPointer ? "MSPointerMove" : "pointermove", Bi = m.msPointer ? "MSPointerUp" : "pointerup", Ri = m.msPointer ? "MSPointerCancel" : "pointercancel", Fe = {
        touchstart: Ii,
        touchmove: Ai,
        touchend: Bi,
        touchcancel: Ri
      ...
      function no(t, e, i) {
        return e === "touchstart" && ao(), Ni[e] ? (i = Ni[e].bind(this, i), t.addEventListener(Fe[e], i, false), i) : (console.warn("wrong event specified:", e), I);
      }
      function oo(t, e, i) {
        if (!Fe[e]) {
        ...
        t.removeEventListener(Fe[e], i, false);
      }
      function so(t) {
        Ot[t.pointerId] = t;
      }
      ...
      function ao() {
        Di || (document.addEventListener(Ii, so, true), document.addEventListener(Ai, ro, true), document.addEventListener(Bi, Hi, true), document.addEventListener(Ri, Hi, true), Di = true);
      }
      function le(t, e) {
      ...
      function ho(t, e) {
        e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && G(e), le(t, e);
      }
      function uo(t) {
        var e = {}, i, n;
        for (n in t)
      ...
      ), Fi = Kt === "webkitTransition" || Kt === "OTransition" ? Kt + "End" : "transitionend";
      function Wi(t) {
      ...
      function H(t, e) {
        t.classList !== void 0 ? t.classList.remove(e) : Ue(t, St((" " + fe(t) + " ").replace(" " + e + " ", " ")));
      }
      function Ue(t, e) {
      ...
      function Lt(t, e, i) {
        var n = e || new x(0, 0);
        t.style[We] = (m.ie3d ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (i ? " scale(" + i + ")" : "");
      }
      function W(t, e) {
        t._leaflet_pos = e, m.any3d ? Lt(t, e) : (t.style.left = e.x + "px", t.style.top = e.y + "px");
      }
      function bt(t) {
      ...
      if ("onselectstart" in document)
        Xt = function() {
          P(window, "selectstart", G);
        }, Jt = function() {
          O(window, "selectstart", G);
        };
      else {
        var $t = de(
        ...
        Xt = function() {
          ...
          $t && (document.documentElement.style[$t] = Ge, Ge = void 0);
        };
      }
      function qe() {
        P(window, "dragstart", G);
      }
      function je() {
        O(window, "dragstart", G);
      }
      var _e, Ke;
      function Ye(t) {
        for (; t.tabIndex === -1; )
          t = t.parentNode;
        t.style && (me(), _e = t, Ke = t.style.outlineStyle, t.style.outlineStyle = "none", P(window, "keydown", me));
      }
      function me() {
        _e && (_e.style.outlineStyle = Ke, _e = void 0, Ke = void 0, O(window, "keydown", me));
      }
      function Vi(t) {
        do
          t = t.parentNode;
      ...
      function $e(t, e, i, n) {
        ...
        !m.touchNative && m.pointer && e.indexOf("touch") === 0 ? s = no(t, e, s) : m.touch && e === "dblclick" ? s = co(t, s) : "addEventListener" in t ? e === "touchstart" || e === "touchmove" || e === "wheel" || e === "mousewheel" ? t.addEventListener(Je[e] || e, s, m.passiveEvents ? { passive: false } : false) : e === "mouseenter" || e === "mouseleave" ? (s = function(a) {
          a = a || window.event, ei(t, a) && r(a);
        }, t.addEventListener(Je[e], s, false)) : t.addEventListener(e, r, false) : t.attachEvent("on" + e, s), t[ht] = t[ht] || {}, t[ht][o] = s;
      }
      function Qe(t, e, i, n, o) {
        ...
        if (!s)
          return this;
        !m.touchNative && m.pointer && e.indexOf("touch") === 0 ? oo(t, e, s) : m.touch && e === "dblclick" ? fo(t, s) : "removeEventListener" in t ? t.removeEventListener(Je[e] || e, s, false) : t.detachEvent("on" + e, s), t[ht][o] = null;
      }
      function Tt(t) {
        return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? t.originalEvent._stopped = true : t.cancelBubble = true, this;
      }
      function ti(t) {
        return $e(t, "wheel", Tt), this;
      }
      function Qt(t) {
        return P(t, "mousedown touchstart dblclick contextmenu", Tt), t._leaflet_disable_click = true, this;
      }
      function G(t) {
        return t.preventDefault ? t.preventDefault() : t.returnValue = false, this;
      }
      function Ct(t) {
        return G(t), Tt(t), this;
      }
      function Gi(t) {
        if (t.composedPath)
      ...
      function qi(t, e) {
        ...
        var i = Xe(e), n = i.boundingClientRect;
        return new x(
      ...
      var po = m.linux && m.chrome ? window.devicePixelRatio : m.mac ? window.devicePixelRatio * 3 : window.devicePixelRatio > 0 ? 2 * window.devicePixelRatio : 1;
      function ji(t) {
      ...
      var go = {
        ...
        run: function(t, e, i, n) {
          this.stop(), this._el = t, this._inProgress = true, this._duration = i || 0.25, this._easeOutPower = 1 / Math.max(n || 0.5, 0.2), this._startPos = bt(t), this._offset = e.subtract(this._startPos), this._startTime = +/* @__PURE__ */ new Date(), this.fire("start"), this._animate();
        },
        // @method stop()
        ...
        _complete: function() {
          D(this._animId), this._inProgress = false, this.fire("end");
        },
        _easeOut: function(t) {
        ...
        initialize: function(t, e) {
          e = E(this, e), this._handlers = [], this._layers = {}, this._zoomBoundLayers = {}, this._sizeChanged = true, this._initContainer(t), this._initLayout(), this._onResize = v2(this._onResize, this), this._initEvents(), e.maxBounds && this.setMaxBounds(e.maxBounds), e.zoom !== void 0 && (this._zoom = this._limitZoom(e.zoom)), e.center && e.zoom !== void 0 && this.setView(C(e.center), e.zoom, { reset: true }), this.callInitHooks(), this._zoomAnimated = Kt && m.any3d && !m.mobileOpera && this.options.zoomAnimation, this._zoomAnimated && (this._createAnimProxy(), P(this._proxy, Fi, this._catchTransitionEnd, this)), this._addLayers(this.options.layers);
        },
        ...
        setView: function(t, e, i) {
          if (e = e === void 0 ? this._zoom : this._limitZoom(e), t = this._limitCenter(C(t), e, this.options.maxBounds), i = i || {}, this._stop(), this._loaded && !i.reset && i !== true) {
        ...
        setZoomAround: function(t, e, i) {
          var n = this.getZoomScale(e), o = this.getSize().divideBy(2), s = t instanceof x ? t : this.latLngToContainerPoint(t), r = s.subtract(o).multiplyBy(1 - 1 / n), a = this.containerPointToLatLng(o.add(r));
          return this.setView(a, e, { zoom: i });
        },
        _getBoundsCenterZoom: function(t, e) {
          e = e || {}, t = t.getBounds ? t.getBounds() : F(t);
          var i = w(e.paddingTopLeft || e.padding || [0, 0]), n = w(e.paddingBottomRight || e.padding || [0, 0]), o = this.getBoundsZoom(t, false, i.add(n));
        ...
        panBy: function(t, e) {
          ...
          if (e.animate !== true && !this.getSize().contains(t))
        ...
        flyTo: function(t, e, i) {
          if (i = i || {}, i.animate === false || !m.any3d)
            return this.setView(t, e, i);
          this._stop();
          var n = this.project(this.getCenter()), o = this.project(t), s = this.getSize(), r = this._zoom;
          t = C(t), e = e === void 0 ? r : e;
          var a = Math.max(s.x, s.y), h = a * this.getZoomScale(r, e), l = o.distanceTo(n) || 1, c = 1.42, y = c * c;
          function T(V) {
            var Me = V ? -1 : 1, ss = V ? h : a, rs = h * h - a * a + Me * y * y * l * l, as = 2 * ss * y * l, fi = rs / as, kn = Math.sqrt(fi * fi + 1) - fi, hs = kn < 1e-9 ? -18 : Math.log(kn);
            return hs;
          }
          function j2(V) {
          ...
          var J = T(0);
          function Ht(V) {
            return a * (U(J) / U(J + c * V));
          }
          function es(V) {
            return a * (U(J) * nt2(J + c * V) - j2(J)) / y;
          }
          function is(V) {
            return 1 - Math.pow(1 - V, 1.5);
          }
          var ns = Date.now(), Mn = (T(1) - J) / c, os = i.duration ? 1e3 * i.duration : 1e3 * Mn * 0.8;
          function Sn() {
            var V = (Date.now() - ns) / os, Me = is(V) * Mn;
            V <= 1 ? (this._flyToFrame = Z(Sn, this), this._move(
              this.unproject(n.add(o.subtract(n).multiplyBy(es(Me) / l)), r),
              this.getScaleZoom(a / Ht(Me), r),
              { flyTo: true }
            )) : this._move(t, e)._moveEnd(true);
          }
          return this._moveStart(true, i.noMoveStart), Sn.call(this), this;
        },
        ...
        panInside: function(t, e) {
          e = e || {};
          var i = w(e.paddingTopLeft || e.padding || [0, 0]), n = w(e.paddingBottomRight || e.padding || [0, 0]), o = this.project(this.getCenter()), s = this.project(t), r = this.getPixelBounds(), a = Y([r.min.add(i), r.max.subtract(n)]), h = a.getSize();
          if (!a.contains(s)) {
            this._enforcingBounds = true;
            var l = s.subtract(a.getCenter()), c = a.extend(s).getSize().subtract(h);
            o.x += l.x < 0 ? -c.x : c.x, o.y += l.y < 0 ? -c.y : c.y, this.panTo(this.unproject(o), e), this._enforcingBounds = false;
          }
          return this;
        },
        ...
        invalidateSize: function(t) {
          ...
          t = d({
            animate: false,
            pan: true
          }, t === true ? { animate: true } : t);
          var e = this.getSize();
          this._sizeChanged = true, this._lastCenter = null;
          var i = this.getSize(), n = e.divideBy(2).round(), o = i.divideBy(2).round(), s = n.subtract(o);
          return !s.x && !s.y ? this : (t.animate && t.pan ? this.panBy(s) : (t.pan && this._rawPanBy(s), this.fire("move"), t.debounceMoveend ? (clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(v2(this.fire, this, "moveend"), 200)) : this.fire("moveend")), this.fire("resize", {
            oldSize: e,
            newSize: i
          }));
        },
        ...
        locate: function(t) {
          ...
          var e = v2(this._handleGeolocationResponse, this), i = v2(this._handleGeolocationError, this);
        ...
        remove: function() {
          ...
          this._locationWatchId !== void 0 && this.stopLocate(), this._stop(), B(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (D(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload");
          var t;
        ...
        getBoundsZoom: function(t, e, i) {
          t = F(t), i = w(i || [0, 0]);
          var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(), a = t.getSouthEast(), h = this.getSize().subtract(i), l = Y(this.project(a, n), this.project(r, n)).getSize(), c = m.any3d ? this.options.zoomSnap : 1, y = h.x / l.x, T = h.y / l.y, j2 = e ? Math.max(y, T) : Math.min(y, T);
          return n = this.getScaleZoom(j2, n), c && (n = Math.round(n / (c / 100)) * (c / 100), n = e ? Math.ceil(n / c) * c : Math.floor(n / c) * c), Math.max(o, Math.min(s, n));
        },
        // @method getSize(): Point
        ...
        unproject: function(t, e) {
          return e = e === void 0 ? this._zoom : e, this.options.crs.pointToLatLng(w(t), e);
        },
        ...
        _initContainer: function(t) {
          var e = this._container = Wi(t);
          if (e) {
            if (e._leaflet_id)
              throw new Error("Map container is already initialized.");
          } else throw new Error("Map container not found.");
          P(e, "scroll", this._onScroll, this), this._containerId = g(e);
        },
        _initLayout: function() {
          var t = this._container;
          this._fadeAnimated = this.options.fadeAnimation && m.any3d, b(t, "leaflet-container" + (m.touch ? " leaflet-touch" : "") + (m.retina ? " leaflet-retina" : "") + (m.ielt9 ? " leaflet-oldie" : "") + (m.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
          var e = Yt(t, "position");
        ...
        _onResize: function() {
          D(this._resizeRequest), this._resizeRequest = Z(
            function() {
        ...
        _findEventTargets: function(t, e) {
          for (var i = [], n, o = e === "mouseout" || e === "mouseover", s = t.target || t.srcElement, r = false; s; ) {
            if (n = this._targets[g(s)], n && (e === "click" || e === "preclick") && this._draggableMoved(n)) {
              r = true;
              break;
            }
            if (n && n.listens(e, true) && (o && !ei(s, t) || (i.push(n), o)) || s === this._container)
              break;
            s = s.parentNode;
          }
          return !i.length && !r && !o && this.listens(e, true) && (i = [this]), i;
        },
        ...
        _handleDOMEvent: function(t) {
          ...
          if (!(!this._loaded || e._leaflet_disable_events || t.type === "click" && this._isClickDisabled(e))) {
            var i = t.type;
            i === "mousedown" && Ye(e), this._fireDOMEvent(t, i);
          }
        },
        ...
        _fireDOMEvent: function(t, e, i) {
          ...
          if (o.length) {
            ...
            for (r = 0; r < o.length; r++)
              if (o[r].fire(e, h, true), h.originalEvent._stopped || o[r].options.bubblingMouseEvents === false && Wt(this._mouseEvents, e) !== -1)
                return;
          }
        },
        ...
        _limitCenter: function(t, e, i) {
          if (!i)
            return t;
          var n = this.project(t, e), o = this.getSize().divideBy(2), s = new A(n.subtract(o), n.add(o)), r = this._getBoundsOffset(s, i, e);
        ...
        _createAnimProxy: function() {
          ...
          this._panes.mapPane.appendChild(t), this.on("zoomanim", function(e) {
            var i = We, n = this._proxy.style[i];
        ...
        _tryAnimatedZoom: function(t, e, i) {
          if (this._animatingZoom)
            return true;
          if (i = i || {}, !this._zoomAnimated || i.animate === false || this._nothingToAnimate() || Math.abs(e - this._zoom) > this.options.zoomAnimationThreshold)
            return false;
          var n = this.getZoomScale(e), o = this._getCenterOffset(t)._divideBy(1 - 1 / n);
          return i.animate !== true && !this.getSize().contains(o) ? false : (Z(function() {
            this._moveStart(true, i.noMoveStart || false)._animateZoom(t, e, true);
          }, this), true);
        },
        _animateZoom: function(t, e, i, n) {
          this._mapPane && (i && (this._animatingZoom = true, this._animateToCenter = t, this._animateToZoom = e, b(this._mapPane, "leaflet-zoom-anim")), this.fire("zoomanim", {
            center: t,
            zoom: e,
            noUpdate: n
          }), this._tempFireZoomEvent || (this._tempFireZoomEvent = this._zoom !== this._animateToZoom), this._move(this._animateToCenter, this._animateToZoom, void 0, true), setTimeout(v2(this._onZoomTransitionEnd, this), 250));
        },
      ...
      var Yi = ot.extend({
        ...
        initialize: function(t, e, i) {
          E(this, i), this._layerControlInputs = [], this._layers = [], this._lastZIndex = 0, this._handlingClick = false, this._preventClick = false;
          for (var n in t)
            this._addLayer(t[n], n);
          for (n in e)
            this._addLayer(e[n], n, true);
        },
        onAdd: function(t) {
        ...
        expand: function() {
          ...
          return t < this._section.clientHeight ? (b(this._section, "leaflet-control-layers-scrollbar"), this._section.style.height = t + "px") : H(this._section, "leaflet-control-layers-scrollbar"), this._checkDisabledLayers(), this;
        },
        ...
        _initLayout: function() {
          ...
          e.setAttribute("aria-haspopup", true), Qt(e), ti(e);
        ...
        _addLayer: function(t, e, i) {
          this._map && t.on("add remove", this._onLayerChange, this), this._layers.push({
            ...
            name: e,
            overlay: i
          }), this.options.sortLayers && this._layers.sort(v2(function(n, o) {
        ...
        _addItem: function(t) {
          ...
          t.overlay ? (n = document.createElement("input"), n.type = "checkbox", n.className = "leaflet-control-layers-selector", n.defaultChecked = i) : n = this._createRadioElement("leaflet-base-layers_" + g(this), i), this._layerControlInputs.push(n), n.layerId = g(t.layer), P(n, "click", this._onInputClick, this);
        ...
        _expandSafely: function() {
          var t = this._section;
          this._preventClick = true, P(t, "click", G), this.expand();
          var e = this;
          setTimeout(function() {
            O(t, "click", G), e._preventClick = false;
          });
        }
      }), yo = function(t, e, i) {
        return new Yi(t, e, i);
        ...
        _createButton: function(t, e, i, n, o) {
          var s = S("a", i, n);
          return s.innerHTML = t, s.href = "#", s.title = e, s.setAttribute("role", "button"), s.setAttribute("aria-label", e), Qt(s), P(s, "click", Ct), P(s, "click", o, this), P(s, "click", this._refocusOnMap, this), s;
        },
        _updateDisabled: function() {
          var t = this._map, e = "leaflet-disabled";
          H(this._zoomInButton, e), H(this._zoomOutButton, e), this._zoomInButton.setAttribute("aria-disabled", "false"), this._zoomOutButton.setAttribute("aria-disabled", "false"), (this._disabled || t._zoom === t.getMinZoom()) && (b(this._zoomOutButton, e), this._zoomOutButton.setAttribute("aria-disabled", "true")), (this._disabled || t._zoom === t.getMaxZoom()) && (b(this._zoomInButton, e), this._zoomInButton.setAttribute("aria-disabled", "true"));
        }
      });
      M.mergeOptions({
        zoomControl: true
      ...
      var wo = function(t) {
        ...
        return new Xi(t);
      }, Po = '<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="12" height="8" viewBox="0 0 12 8" class="leaflet-attribution-flag"><path fill="#4C7BE1" d="M0 0h12v4H0z"/><path fill="#FFD500" d="M0 4h12v3H0z"/><path fill="#E0BC00" d="M0 7h12v1H0z"/></svg>', ni = ot.extend({
        // @section
        ...
        options: {
          ...
          prefix: '<a href="https://leafletjs.com" title="A JavaScript library for interactive maps">' + (m.inlineSvg ? Po + " " : "") + "Leaflet</a>"
        },
        initialize: function(t) {
          E(this, t), this._attributions = {};
        },
        onAdd: function(t) {
          t.attributionControl = this, this._container = S("div", "leaflet-control-attribution"), Qt(this._container);
      ...
      ot.Layers = Yi, ot.Zoom = ii, ot.Scale = Xi, ot.Attribution = ni, te.layers = yo, te.zoom = wo, te.scale = xo, te.attribution = Lo;
      var ut = q.extend({
        initialize: function(t) {
          this._map = t;
        },
      ...
      var bo = { Events: Q }, Ji = m.touch ? "touchstart mousedown" : "mousedown", wt = Gt.extend({
        options: {
          // @section
        ...
        enable: function() {
          this._enabled || (P(this._dragStartTarget, Ji, this._onDown, this), this._enabled = true);
        },
        // @method disable()
        // Disables the dragging ability
        disable: function() {
          this._enabled && (wt._dragging === this && this.finishDrag(true), O(this._dragStartTarget, Ji, this._onDown, this), this._enabled = false, this._moved = false);
        },
        _onDown: function(t) {
          if (this._enabled && (this._moved = false, !Ve(this._element, "leaflet-zoom-anim"))) {
            if (t.touches && t.touches.length !== 1) {
              wt._dragging === this && this.finishDrag();
              return;
            }
            if (!(wt._dragging || t.shiftKey || t.which !== 1 && t.button !== 1 && !t.touches) && (wt._dragging = this, this._preventOutline && Ye(this._element), qe(), Xt(), !this._moving)) {
              this.fire("down");
              var e = t.touches ? t.touches[0] : t, i = Vi(this._element);
              this._startPoint = new x(e.clientX, e.clientY), this._startPos = bt(this._element), this._parentScale = Xe(i);
        ...
        _onMove: function(t) {
          if (this._enabled) {
            ...
            !i.x && !i.y || Math.abs(i.x) + Math.abs(i.y) < this.options.clickTolerance || (i.x /= this._parentScale.x, i.y /= this._parentScale.y, G(t), this._moved || (this.fire("dragstart"), this._moved = true, b(document.body, "leaflet-dragging"), this._lastTarget = t.target || t.srcElement, window.SVGElementInstance && this._lastTarget instanceof window.SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), b(this._lastTarget, "leaflet-drag-target")), this._newPos = this._startPos.add(i), this._moving = true, this._lastEvent = t, this._updatePosition());
          }
        },
        ...
        finishDrag: function(t) {
          H(document.body, "leaflet-dragging"), this._lastTarget && (H(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), O(document, "mousemove touchmove", this._onMove, this), O(document, "mouseup touchend touchcancel", this._onUp, this), je(), Jt();
      ...
      function $i(t, e, i) {
        var n, o = [1, 4, 2, 8], s, r, a, h, l, c, y, T;
        for (s = 0, c = t.length; s < c; s++)
          t[s]._code = Mt(t[s], e);
        for (a = 0; a < 4; a++) {
          for (y = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
            h = t[s], l = t[r], h._code & y ? l._code & y || (T = pe(l, h, y, e, i), T._code = Mt(T, e), n.push(T)) : (l._code & y && (T = pe(l, h, y, e, i), T._code = Mt(T, e), n.push(T)), n.push(h));
          t = n;
        }
        return t;
      }
      function Qi(t, e) {
        var i, n, o, s, r, a, h, l, c;
        if (!t || t.length === 0)
          throw new Error("latlngs not passed");
        it(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
        var y = C([0, 0]), T = F(t), j2 = T.getNorthWest().distanceTo(T.getSouthWest()) * T.getNorthEast().distanceTo(T.getNorthWest());
        j2 < 1700 && (y = oi(t));
        var U = t.length, nt2 = [];
        for (i = 0; i < U; i++) {
          var J = C(t[i]);
          nt2.push(e.project(C([J.lat - y.lat, J.lng - y.lng])));
        }
        for (a = h = l = 0, i = 0, n = U - 1; i < U; n = i++)
          o = nt2[i], s = nt2[n], r = o.y * s.x - s.y * o.x, h += (o.x + s.x) * r, l += (o.y + s.y) * r, a += r * 3;
        a === 0 ? c = nt2[0] : c = [h / a, l / a];
        var Ht = e.unproject(w(c));
        return C([Ht.lat + y.lat, Ht.lng + y.lng]);
      }
      function oi(t) {
      ...
      function tn(t, e) {
        if (!e || !t.length)
          return t.slice();
        var i = e * e;
        return t = So(t, i), t = Mo(t, i), t;
      }
      function en(t, e, i) {
        return Math.sqrt(ee(t, e, i, true));
      }
      function Co(t, e, i) {
        return ee(t, e, i);
      }
      ...
      function si(t, e, i, n, o) {
        var s = 0, r, a, h;
        for (a = n + 1; a <= o - 1; a++)
          h = ee(t[a], t[n], t[o], true), h > s && (r = a, s = h);
        s > i && (e[r] = 1, si(t, e, i, n, r), si(t, e, i, r, o));
      }
      function So(t, e) {
      ...
      function on(t, e, i, n, o) {
        var s = n ? nn : Mt(t, i), r = Mt(e, i), a, h, l;
        for (nn = r; ; ) {
          if (!(s | r))
            return [t, e];
          if (s & r)
            return false;
          a = s || r, h = pe(t, e, a, i, o), l = Mt(h, i), a === s ? (t = h, s = l) : (e = h, r = l);
        }
      }
      function pe(t, e, i, n, o) {
        var s = e.x - t.x, r = e.y - t.y, a = n.min, h = n.max, l, c;
        return i & 8 ? (l = t.x + s * (h.y - t.y) / r, c = h.y) : i & 4 ? (l = t.x + s * (a.y - t.y) / r, c = a.y) : i & 2 ? (l = h.x, c = t.y + r * (h.x - t.x) / s) : i & 1 && (l = a.x, c = t.y + r * (a.x - t.x) / s), new x(l, c, o);
      }
      function Mt(t, e) {
        var i = 0;
      ...
      function ee(t, e, i, n) {
        var o = e.x, s = e.y, r = i.x - o, a = i.y - s, h = r * r + a * a, l;
        return h > 0 && (l = ((t.x - o) * r + (t.y - s) * a) / h, l > 1 ? (o = i.x, s = i.y) : l > 0 && (o += r * l, s += a * l)), r = t.x - o, a = t.y - s, n ? r * r + a * a : new x(o, s);
      }
      function it(t) {
        return !$(t[0]) || typeof t[0][0] != "object" && typeof t[0][0] < "u";
      }
      function sn(t) {
        return console.warn("Deprecated use of _flat, please use L.LineUtil.isFlat instead."), it(t);
      }
      function rn(t, e) {
        var i, n, o, s, r, a, h, l;
        if (!t || t.length === 0)
          throw new Error("latlngs not passed");
        it(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
        var c = C([0, 0]), y = F(t), T = y.getNorthWest().distanceTo(y.getSouthWest()) * y.getNorthEast().distanceTo(y.getNorthWest());
        T < 1700 && (c = oi(t));
        var j2 = t.length, U = [];
        for (i = 0; i < j2; i++) {
          var nt2 = C(t[i]);
          U.push(e.project(C([nt2.lat - c.lat, nt2.lng - c.lng])));
        }
        for (i = 0, n = 0; i < j2 - 1; i++)
          n += U[i].distanceTo(U[i + 1]) / 2;
        if (n === 0)
          l = U[0];
        else
          for (i = 0, s = 0; i < j2 - 1; i++)
            if (r = U[i], a = U[i + 1], o = r.distanceTo(a), s += o, s > n) {
              h = (s - n) / o, l = [
                a.x - h * (a.x - r.x),
                a.y - h * (a.y - r.y)
              ];
        ...
        return C([J.lat + c.lat, J.lng + c.lng]);
      }
      var zo = {
        __proto__: null,
        simplify: tn,
        pointToSegmentDistance: en,
        closestPointOnSegment: Co,
        clipSegment: on,
        ...
        unproject: function(t) {
          for (var e = 180 / Math.PI, i = this.R, n = this.R_MINOR / i, o = Math.sqrt(1 - n * n), s = Math.exp(-t.y / i), r = Math.PI / 2 - 2 * Math.atan(s), a = 0, h = 0.1, l; a < 15 && Math.abs(h) > 1e-7; a++)
            l = o * Math.sin(r), l = Math.pow((1 - l) / (1 + l), o / 2), h = Math.PI / 2 - 2 * Math.atan(s * l) - r, r += h;
      ...
      ct.Earth = yt, ct.EPSG3395 = Oo, ct.EPSG3857 = Ae, ct.EPSG900913 = Nn, ct.EPSG4326 = an, ct.Simple = Zo;
      var st = Gt.extend({
      ...
      var At = st.extend({
        ...
        _setIconStyles: function(t, e) {
          ...
          var o = w(n), s = w(e === "shadow" && i.shadowAnchor || i.iconAnchor || o && o.divideBy(2, true));
      ...
      var ie = Bt.extend({
        ...
        _getIconUrl: function(t) {
          return typeof ie.imagePath != "string" && (ie.imagePath = this._detectIconPath()), (this.options.imagePath || ie.imagePath) + Bt.prototype._getIconUrl.call(this, t);
        },
        ...
        _detectIconPath: function() {
          var t = S("div", "leaflet-default-icon-path", document.body), e = Yt(t, "background-image") || Yt(t, "backgroundImage");
        ...
        _adjustPan: function(t) {
          var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed, o = this._marker.options.autoPanPadding, s = bt(e._icon), r = i.getPixelBounds(), a = i.getPixelOrigin(), h = Y(
          ...
          if (!h.contains(s)) {
            ...
            i.panBy(l, { animate: false }), this._draggable._newPos._add(l), this._draggable._startPos._add(l), W(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = Z(this._adjustPan.bind(this, t));
          }
        },
        ...
        _onPreDrag: function(t) {
          this._marker.options.autoPan && (D(this._panRequest), this._panRequest = Z(this._adjustPan.bind(this, t)));
        },
        _onDrag: function(t) {
        ...
        _initIcon: function() {
          ...
          i !== this._icon && (this._icon && this._removeIcon(), n = true, t.title && (i.title = t.title), i.tagName === "IMG" && (i.alt = t.alt || "")), b(i, e), t.keyboard && (i.tabIndex = "0", i.setAttribute("role", "button")), this._icon = i, t.riseOnHover && this.on({
            mouseover: this._bringToFront,
            mouseout: this._resetZIndex
          }), this.options.autoPanOnFocus && P(i, "focus", this._panOnFocus, this);
          var o = t.icon.createShadow(this._shadow), s = false;
          o !== this._shadow && (this._removeShadow(), s = true), o && (b(o, e), o.alt = ""), this._shadow = o, t.opacity < 1 && this._updateOpacity(), n && this.getPane().appendChild(this._icon), this._initInteraction(), o && s && this.getPane(t.shadowPane).appendChild(this._shadow);
        },
        ...
        _initInteraction: function() {
          if (this.options.interactive && (b(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), hn)) {
        ...
        _panOnFocus: function() {
          var t = this._map;
          if (t) {
            var e = this.options.icon.options, i = e.iconSize ? w(e.iconSize) : w(0, 0), n = e.iconAnchor ? w(e.iconAnchor) : w(0, 0);
      ...
      var xt = st.extend({
        ...
        initialize: function(t, e) {
          E(this, e), this._latlng = C(t), this._radius = this.options.radius;
        },
        // @method setLatLng(latLng: LatLng): this
      ...
      var hi = ve.extend({
        initialize: function(t, e, i) {
          if (typeof e == "number" && (e = d({}, i, { radius: e })), E(this, e), this._latlng = C(t), isNaN(this.options.radius))
        ...
        _project: function() {
          ...
          if (n.distance === yt.distance) {
            var o = Math.PI / 180, s = this._mRadius / yt.R / o, r = i.project([e + s, t]), a = i.project([e - s, t]), h = r.add(a).divideBy(2), l = i.unproject(h).lat, c = Math.acos((Math.cos(s * o) - Math.sin(e * o) * Math.sin(l * o)) / (Math.cos(e * o) * Math.cos(l * o))) / o;
            (isNaN(c) || c === 0) && (c = s / Math.cos(Math.PI / 180 * e)), this._point = h.subtract(i.getPixelOrigin()), this._radius = isNaN(c) ? 0 : h.x - i.project([l, t - c]).x, this._radiusY = h.y - r.y;
          } else {
      ...
      var dt = xt.extend({
        ...
        closestLayerPoint: function(t) {
          for (var e = 1 / 0, i = null, n = ee, o, s, r = 0, a = this._parts.length; r < a; r++)
            for (var h = this._parts[r], l = 1, c = h.length; l < c; l++) {
              o = h[l - 1], s = h[l];
              var y = n(t, o, s, true);
              y < e && (e = y, i = n(t, o, s));
            }
          ...
          if (this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
            ...
            for (i = 0, o = 0, s = this._rings.length; i < s; i++)
              for (h = this._rings[i], n = 0, r = h.length; n < r - 1; n++)
                a = on(h[n], h[n + 1], t, n, true), a && (e[o] = e[o] || [], e[o].push(a[0]), (a[1] !== h[n + 1] || n === r - 2) && (e[o].push(a[1]), o++));
          }
        },
      ...
      var Rt = dt.extend({
        ...
        _setLatLngs: function(t) {
          dt.prototype._setLatLngs.call(this, t), it(this._latlngs) && (this._latlngs = [this._latlngs]);
        },
        _defaultShape: function() {
          return it(this._latlngs[0]) ? this._latlngs[0] : this._latlngs[0][0];
        },
        _clipPoints: function() {
          ...
          if (t = new A(t.min.subtract(i), t.max.add(i)), this._parts = [], !(!this._pxBounds || !this._pxBounds.intersects(t))) {
            ...
            for (var n = 0, o = this._rings.length, s; n < o; n++)
              s = $i(this._rings[n], t, true), s.length && this._parts.push(s);
          }
        },
        _updatePath: function() {
        ...
        _containsPoint: function(t) {
          ...
          return e || dt.prototype._containsPoint.call(this, t, true);
        }
      });
      function Fo(t, e) {
        return new Rt(t, e);
      ...
      var _t = ft.extend({
        ...
        addData: function(t) {
          ...
          if (s.filter && !s.filter(t))
            return this;
          var r = ye(t, s);
          return r ? (r.feature = Pe(t), r.defaultOptions = r.options, this.resetStyle(r), s.onEachFeature && s.onEachFeature(t, r), this.addLayer(r)) : this;
        },
      ...
      function ye(t, e) {
        var i = t.type === "Feature" ? t.geometry : t, n = i ? i.coordinates : null, o = [], s = e && e.pointToLayer, r = e && e.coordsToLatLng || ui, a, h, l, c;
        if (!n && !i)
          return null;
        switch (i.type) {
          case "Point":
          ...
          case "MultiLineString":
            return h = we(n, i.type === "LineString" ? 0 : 1, r), new dt(h, e);
          case "Polygon":
          case "MultiPolygon":
            return h = we(n, i.type === "Polygon" ? 1 : 2, r), new Rt(h, e);
      ...
      function we(t, e, i) {
        for (var n = [], o = 0, s = t.length, r; o < s; o++)
          r = e ? we(t[o], e - 1, i) : (i || ui)(t[o]), n.push(r);
        return n;
      }
      function li(t, e) {
        return t = C(t), t.alt !== void 0 ? [K(t.lng, e), K(t.lat, e), K(t.alt, e)] : [K(t.lng, e), K(t.lat, e)];
      }
      function xe(t, e, i, n) {
        for (var o = [], s = 0, r = t.length; s < r; s++)
          o.push(e ? xe(t[s], it(t[s]) ? 0 : e - 1, i, n) : li(t[s], n));
        return !e && i && o.length > 0 && o.push(o[0].slice()), o;
      }
      function Nt(t, e) {
        return t.feature ? d({}, t.feature, { geometry: e }) : Pe(e);
      }
      function Pe(t) {
      ...
      ge.include(ci), hi.include(ci), ve.include(ci), dt.include({
        toGeoJSON: function(t) {
          var e = !it(this._latlngs), i = xe(this._latlngs, e ? 1 : 0, false, t);
          return Nt(this, {
        ...
        toGeoJSON: function(t) {
          var e = !it(this._latlngs), i = e && !it(this._latlngs[0]), n = xe(this._latlngs, i ? 2 : e ? 1 : 0, true, t);
      ...
      var Wo = ln, Le = st.extend({
        ...
        initialize: function(t, e, i) {
          this._url = t, this._bounds = F(e), E(this, i);
        },
        onAdd: function() {
        ...
        _initImage: function() {
          ...
          if (b(e, "leaflet-image-layer"), this._zoomAnimated && b(e, "leaflet-zoom-animated"), this.options.className && b(e, this.options.className), e.onselectstart = I, e.onmousemove = I, e.onload = v2(this.fire, this, "load"), e.onerror = v2(this._overlayOnError, this, "error"), (this.options.crossOrigin || this.options.crossOrigin === "") && (e.crossOrigin = this.options.crossOrigin === true ? "" : this.options.crossOrigin), this.options.zIndex && this._updateZIndex(), t) {
            this._url = e.src;
            return;
          }
        ...
        _initImage: function() {
          ...
          if (b(e, "leaflet-image-layer"), this._zoomAnimated && b(e, "leaflet-zoom-animated"), this.options.className && b(e, this.options.className), e.onselectstart = I, e.onmousemove = I, e.onloadeddata = v2(this.fire, this, "load"), t) {
      ...
      var fn = Le.extend({
        _initImage: function() {
          ...
          b(t, "leaflet-image-layer"), this._zoomAnimated && b(t, "leaflet-zoom-animated"), this.options.className && b(t, this.options.className), t.onselectstart = I, t.onmousemove = I;
        }
      ...
      var lt = st.extend({
        ...
        initialize: function(t, e) {
          t && (t instanceof z || $(t)) ? (this._latlng = C(t), E(this, e)) : (E(this, t), this._source = e), this.options.content && (this._content = this.options.content);
        },
        ...
        onRemove: function(t) {
          t._fadeAnimated ? (et(this._container, 0), this._removeTimeout = setTimeout(v2(B, void 0, this._container), 200)) : B(this._container), this.options.interactive && (H(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container));
        },
        ...
        _updatePosition: function() {
          if (this._map) {
            var t = this._map.latLngToLayerPoint(this._latlng), e = w(this.options.offset), i = this._getAnchor();
      ...
      var be = lt.extend({
        ...
        onAdd: function(t) {
          lt.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, true), this._source instanceof xt || this._source.on("preclick", Tt));
        },
        onRemove: function(t) {
          lt.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, true), this._source instanceof xt || this._source.off("preclick", Tt));
        },
        getEvents: function() {
        ...
        _initLayout: function() {
          ...
          if (this._contentNode = S("div", t + "-content", i), Qt(e), ti(this._contentNode), P(e, "contextmenu", Tt), this._tipContainer = S("div", t + "-tip-container", e), this._tip = S("div", t + "-tip", this._tipContainer), this.options.closeButton) {
        ...
        _updateLayout: function() {
          ...
          o && n > o ? (e.height = o + "px", b(t, s)) : H(t, s), this._containerWidth = this._container.offsetWidth;
        },
        _animateZoom: function(t) {
        ...
        _adjustPan: function() {
          if (this.options.autoPan) {
            ...
            var t = this._map, e = parseInt(Yt(this._container, "marginBottom"), 10) || 0, i = this._container.offsetHeight + e, n = this._containerWidth, o = new x(this._containerLeft, -i - this._containerBottom);
            o._add(bt(this._container));
            var s = t.layerPointToContainerPoint(o), r = w(this.options.autoPanPadding), a = w(this.options.autoPanPaddingTopLeft || r), h = w(this.options.autoPanPaddingBottomRight || r), l = t.getSize(), c = 0, y = 0;
            s.x + n + h.x > l.x && (c = s.x + n - l.x + h.x), s.x - c - a.x < 0 && (c = s.x - a.x), s.y + i + h.y > l.y && (y = s.y + i - l.y + h.y), s.y - y - a.y < 0 && (y = s.y - a.y), (c || y) && (this.options.keepInView && (this._autopanning = true), t.fire("autopanstart").panBy([c, y]));
          }
        },
        _getAnchor: function() {
      ...
      var Te = lt.extend({
        ...
        onAdd: function(t) {
          lt.prototype.onAdd.call(this, t), this.setOpacity(this.options.opacity), t.fire("tooltipopen", { tooltip: this }), this._source && (this.addEventParent(this._source), this._source.fire("tooltipopen", { tooltip: this }, true));
        },
        onRemove: function(t) {
          lt.prototype.onRemove.call(this, t), t.fire("tooltipclose", { tooltip: this }), this._source && (this.removeEventParent(this._source), this._source.fire("tooltipclose", { tooltip: this }, true));
        },
        getEvents: function() {
          var t = lt.prototype.getEvents.call(this);
        ...
        _initLayout: function() {
          ...
          this._contentNode = this._container = S("div", e), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "leaflet-tooltip-" + g(this));
        },
        _updateLayout: function() {
        },
        _adjustPan: function() {
        ...
        _setPosition: function(t) {
          var e, i, n = this._map, o = this._container, s = n.latLngToContainerPoint(n.getCenter()), r = n.layerPointToContainerPoint(t), a = this.options.direction, h = o.offsetWidth, l = o.offsetHeight, c = w(this.options.offset), y = this._getAnchor();
          a === "top" ? (e = h / 2, i = l) : a === "bottom" ? (e = h / 2, i = 0) : a === "center" ? (e = h / 2, i = l / 2) : a === "right" ? (e = 0, i = l / 2) : a === "left" ? (e = h, i = l / 2) : r.x < s.x ? (a = "right", e = 0, i = l / 2) : (a = "left", e = h + (c.x + y.x) * 2, i = l / 2), t = t.subtract(w(e, i, true)).add(c).add(y), H(o, "leaflet-tooltip-right"), H(o, "leaflet-tooltip-left"), H(o, "leaflet-tooltip-top"), H(o, "leaflet-tooltip-bottom"), b(o, "leaflet-tooltip-" + a), W(o, t);
        },
        _updatePosition: function() {
      ...
      var dn = Bt.extend({
        ...
        createIcon: function(t) {
          ...
          if (i.html instanceof Element ? (ce(e), e.appendChild(i.html)) : e.innerHTML = i.html !== false ? i.html : "", i.bgPos) {
            var n = w(i.bgPos);
      ...
      var ne = st.extend({
        ...
        getEvents: function() {
          ...
          return this.options.updateWhenIdle || (this._onMove || (this._onMove = Pt(this._onMoveEnd, this.options.updateInterval, this)), t.move = this._onMove), this._zoomAnimated && (t.zoomanim = this._animateZoom), t;
        },
        // @section Extension methods
          ...
          if (this._map && !m.ielt9) {
            ...
            for (var n in this._tiles) {
              ...
              if (!(!o.current || !o.loaded)) {
                ...
                et(o.el, s), s < 1 ? e = true : (o.active ? i = true : this._onOpaqueTile(o), o.active = true);
              }
            }
            i && !this._noPrune && this._pruneTiles(), e && (D(this._fadeFrame), this._fadeFrame = Z(this._updateOpacity, this));
          }
        },
        _onOpaqueTile: I,
        ...
        _updateLevels: function() {
          ...
          if (t !== void 0) {
            ...
            return n || (n = this._levels[t] = {}, n.el = S("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = e, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), I(n.el.offsetWidth), this._onCreateLevel(n)), this._level = n, n;
          }
        },
        _onUpdateLevel: I,
        _onRemoveLevel: I,
        ...
        _retainParent: function(t, e, i, n) {
          var o = Math.floor(t / 2), s = Math.floor(e / 2), r = i - 1, a = new x(+o, +s);
          a.z = +r;
          var h = this._tileCoordsToKey(a), l = this._tiles[h];
          return l && l.active ? (l.retain = true, true) : (l && l.loaded && (l.retain = true), r > n ? this._retainParent(o, s, r, n) : false);
        },
        ...
        _update: function(t) {
          ...
          if (e) {
            ...
            if (t === void 0 && (t = e.getCenter()), this._tileZoom !== void 0) {
              var n = this._getTiledPixelBounds(t), o = this._pxBoundsToTileRange(n), s = o.getCenter(), r = [], a = this.options.keepBuffer, h = new A(
              ...
              for (var l in this._tiles) {
                ...
                (c.z !== this._tileZoom || !h.contains(new x(c.x, c.y))) && (this._tiles[l].current = false);
              }
              ...
              for (var y = o.min.y; y <= o.max.y; y++)
                for (var T = o.min.x; T <= o.max.x; T++) {
                  var j2 = new x(T, y);
                  if (j2.z = this._tileZoom, !!this._isValidTile(j2)) {
                    var U = this._tiles[this._tileCoordsToKey(j2)];
                    U ? U.current = true : r.push(j2);
                  }
                }
              if (r.sort(function(J, Ht) {
                return J.distanceTo(s) - Ht.distanceTo(s);
              }), r.length !== 0) {
                this._loading || (this._loading = true, this.fire("loading"));
                var nt2 = document.createDocumentFragment();
                for (T = 0; T < r.length; T++)
                  this._addTile(r[T], nt2);
                this._level.el.appendChild(nt2);
              }
            }
          }
        },
        ...
        _tileCoordsToBounds: function(t) {
          var e = this._tileCoordsToNwSe(t), i = new X(e[0], e[1]);
        ...
        _initTile: function(t) {
          ...
          t.style.width = e.x + "px", t.style.height = e.y + "px", t.onselectstart = I, t.onmousemove = I, m.ielt9 && this.options.opacity < 1 && et(t, this.options.opacity);
        },
        _addTile: function(t, e) {
          var i = this._getTilePos(t), n = this._tileCoordsToKey(t), o = this.createTile(this._wrapCoords(t), v2(this._tileReady, this, t));
          this._initTile(o), this.createTile.length < 2 && Z(v2(this._tileReady, this, t, null, o)), W(o, i), this._tiles[n] = {
            el: o,
            coords: t,
            current: true
        ...
        _tileReady: function(t, e, i) {
          ...
          i = this._tiles[n], i && (i.loaded = +/* @__PURE__ */ new Date(), this._map._fadeAnimated ? (et(i.el, 0), D(this._fadeFrame), this._fadeFrame = Z(this._updateOpacity, this)) : (i.active = true, this._pruneTiles()), e || (b(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
            tile: i.el,
            coords: t
          })), this._noTilesToLoad() && (this._loading = false, this.fire("load"), m.ielt9 || !this._map._fadeAnimated ? Z(this._pruneTiles, this) : setTimeout(v2(this._pruneTiles, this), 250)));
        },
        ...
        _wrapCoords: function(t) {
          var e = new x(
            this._wrapX ? tt(t.x, this._wrapX) : t.x,
            this._wrapY ? tt(t.y, this._wrapY) : t.y
          );
          return e.z = t.z, e;
        },
      ...
      var Dt = ne.extend({
        ...
        createTile: function(t, e) {
          ...
          return P(i, "load", v2(this._tileOnLoad, this, e, i)), P(i, "error", v2(this._tileOnError, this, e, i)), (this.options.crossOrigin || this.options.crossOrigin === "") && (i.crossOrigin = this.options.crossOrigin === true ? "" : this.options.crossOrigin), typeof this.options.referrerPolicy == "string" && (i.referrerPolicy = this.options.referrerPolicy), i.alt = "", i.src = this.getTileUrl(t), i;
        },
        // @section Extension methods
        // @uninheritable
        ...
        getTileUrl: function(t) {
          ...
          return he(this._url, d(e, this.options));
        },
        _tileOnLoad: function(t, e) {
          m.ielt9 ? setTimeout(v2(t, this, null, e), 0) : t(null, e);
        },
        ...
        _abortLoading: function() {
          var t, e;
          for (t in this._tiles)
            if (this._tiles[t].coords.z !== this._tileZoom && (e = this._tiles[t].el, e.onload = I, e.onerror = I, !e.complete)) {
              e.src = kt;
        ...
        _removeTile: function(t) {
          var e = this._tiles[t];
          if (e)
            return e.el.setAttribute("src", kt), ne.prototype._removeTile.call(this, t);
        },
        _tileReady: function(t, e, i) {
          if (!(!this._map || i && i.getAttribute("src") === kt))
            return ne.prototype._tileReady.call(this, t, e, i);
        }
      });
      function _n(t, e) {
        return new Dt(t, e);
      ...
      var mn = Dt.extend({
        ...
        getTileUrl: function(t) {
          var e = this._tileCoordsToNwSe(t), i = this._crs, n = Y(i.project(e[0]), i.project(e[1])), o = n.min, s = n.max, r = (this._wmsVersion >= 1.3 && this._crs === an ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","), a = Dt.prototype.getTileUrl.call(this, t);
          return a + ae(this.wmsParams, a, this.options.uppercase) + (this.options.uppercase ? "&BBOX=" : "&bbox=") + r;
        },
      ...
      var mt = st.extend({
        ...
        initialize: function(t) {
          E(this, t), g(this), this._layers = this._layers || {};
        },
        onAdd: function() {
        ...
        _updateTransform: function(t, e) {
          ...
          m.any3d ? Lt(this._container, s, i) : W(this._container, s);
        },
        _reset: function() {
        ...
        _initContainer: function() {
          ...
          P(t, "mousemove", this._onMouseMove, this), P(t, "click dblclick mousedown mouseup contextmenu", this._onClick, this), P(t, "mouseout", this._handleMouseOut, this), t._leaflet_disable_events = true, this._ctx = t.getContext("2d");
        },
        _destroyContainer: function() {
          D(this._redrawRequest), delete this._ctx, B(this._container), O(this._container), delete this._container;
        },
        _updatePaths: function() {
        ...
        _update: function() {
          if (!(this._map._animatingZoom && this._bounds)) {
            ...
            W(e, t.min), e.width = n * i.x, e.height = n * i.y, e.style.width = i.x + "px", e.style.height = i.y + "px", m.retina && this._ctx.scale(2, 2), this._ctx.translate(-t.min.x, -t.min.y), this.fire("update");
          }
        },
        _reset: function() {
          mt.prototype._reset.call(this), this._postponeUpdatePaths && (this._postponeUpdatePaths = false, this._updatePaths());
        },
        ...
        _handleMouseOut: function(t) {
          ...
          e && (H(this._container, "leaflet-interactive"), this._fireEvent([e], t, "mouseout"), this._hoveredLayer = null, this._mouseHoverThrottled = false);
        },
        _handleMouseHover: function(t, e) {
          if (!this._mouseHoverThrottled) {
            for (var i, n, o = this._drawFirst; o; o = o.next)
              i = o.layer, i.options.interactive && i._containsPoint(e) && (n = i);
            n !== this._hoveredLayer && (this._handleMouseOut(t), n && (b(this._container, "leaflet-interactive"), this._fireEvent([n], t, "mouseover"), this._hoveredLayer = n)), this._fireEvent(this._hoveredLayer ? [this._hoveredLayer] : false, t), this._mouseHoverThrottled = true, setTimeout(v2(function() {
      ...
      var oe = (function() {
        ...
        _initPath: function(t) {
          var e = t._container = oe("shape");
          b(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = oe("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[g(t)] = t;
        },
        _addPath: function(t) {
          var e = t._container;
        ...
        _initPath: function(t) {
          ...
          t.options.className && b(e, t.options.className), t.options.interactive && b(e, "leaflet-interactive"), this._updateStyle(t), this._layers[g(t)] = t;
        },
        _addPath: function(t) {
          this._rootGroup || this._initContainer(), this._rootGroup.appendChild(t._path), t.addInteractiveTarget(t._path);
        },
        _removePath: function(t) {
          B(t._path), t.removeInteractiveTarget(t._path), delete this._layers[g(t)];
        },
        _updatePath: function(t) {
      ...
      m.vml && se.include(Jo);
      function vn(t) {
        return m.svg || m.vml ? new se(t) : null;
      }
      M.include({
      ...
      se.create = Ce, se.pointsToPath = xi, _t.geometryToLayer = ye, _t.coordsToLatLng = ui, _t.coordsToLatLngs = we, _t.latLngToCoords = li, _t.latLngsToCoords = xe, _t.getFeature = Nt, _t.asFeature = Pe, M.mergeOptions({
      ...
      var wn = ut.extend({
        ...
        _onMouseDown: function(t) {
          if (!t.shiftKey || t.which !== 1 && t.button !== 1)
            return false;
          this._clearDeferredResetState(), this._resetState(), Xt(), qe(), this._startPoint = this._map.mouseEventToContainerPoint(t), P(document, {
            contextmenu: Ct,
        ...
        _onMouseMove: function(t) {
          this._moved || (this._moved = true, this._box = S("div", "leaflet-zoom-box", this._container), b(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")), this._point = this._map.mouseEventToContainerPoint(t);
        ...
        _finish: function() {
          this._moved && (B(this._box), H(this._container, "leaflet-crosshair")), Jt(), je(), O(document, {
            contextmenu: Ct,
            mousemove: this._onMouseMove,
            mouseup: this._onMouseUp,
            keydown: this._onKeyDown
        ...
        _onMouseUp: function(t) {
          if (!(t.which !== 1 && t.button !== 1) && (this._finish(), !!this._moved)) {
            this._clearDeferredResetState(), this._resetStateTimeout = setTimeout(v2(this._resetState, this), 0);
            var e = new X(
      ...
      M.addInitHook("addHandler", "boxZoom", wn), M.mergeOptions({
      ...
      M.addInitHook("addHandler", "doubleClickZoom", xn), M.mergeOptions({
      ...
      var Pn = ut.extend({
        ...
        _onDragEnd: function(t) {
          ...
          if (e.fire("dragend", t), n)
            ...
            var o = this._lastPos.subtract(this._positions[0]), s = (this._lastTime - this._times[0]) / 1e3, r = i.easeLinearity, a = o.multiplyBy(r / s), h = a.distanceTo([0, 0]), l = Math.min(i.inertiaMaxSpeed, h), c = a.multiplyBy(l / h), y = l / (i.inertiaDeceleration * r), T = c.multiplyBy(-y / 2).round();
            !T.x && !T.y ? e.fire("moveend") : (T = e._limitOffset(T, e.options.maxBounds), Z(function() {
              e.panBy(T, {
                duration: y,
                easeLinearity: r,
                noMoveStart: true,
      ...
      M.addInitHook("addHandler", "dragging", Pn), M.mergeOptions({
        // @option keyboard: Boolean = true
          ...
          if (!(t.altKey || t.ctrlKey || t.metaKey)) {
            ...
            if (e in this._panKeys) {
              if (!i._panAnim || !i._panAnim._inProgress)
                if (n = this._panKeys[e], t.shiftKey && (n = w(n).multiplyBy(3)), i.options.maxBounds && (n = i._limitOffset(w(n), i.options.maxBounds)), i.options.worldCopyJump) {
      ...
      M.addInitHook("addHandler", "keyboard", Ln), M.mergeOptions({
      ...
      var bn = ut.extend({
        ...
        _onWheelScroll: function(t) {
          ...
          clearTimeout(this._timer), this._timer = setTimeout(v2(this._performZoom, this), n), Ct(t);
        },
      ...
      M.addInitHook("addHandler", "scrollWheelZoom", bn);
      var Qo = 600;
      M.mergeOptions({
      ...
      var Tn = ut.extend({
        ...
        _onDown: function(t) {
          if (clearTimeout(this._holdTimeout), t.touches.length === 1) {
            var e = t.touches[0];
            this._startPos = this._newPos = new x(e.clientX, e.clientY), this._holdTimeout = setTimeout(v2(function() {
              this._cancel(), this._isTapValid() && (P(document, "touchend", G), P(document, "touchend touchcancel", this._cancelClickPrevent), this._simulateEvent("contextmenu", e));
            }, this), Qo), P(document, "touchend touchcancel contextmenu", this._cancel, this), P(document, "touchmove", this._onMove, this);
          }
        },
        _cancelClickPrevent: function t() {
          O(document, "touchend", G), O(document, "touchend touchcancel", t);
        },
        _cancel: function() {
      ...
      M.addInitHook("addHandler", "tapHold", Tn), M.mergeOptions({
        // @section Touch interaction options
      ...
      var Cn = ut.extend({
        addHooks: function() {
          b(this._map._container, "leaflet-touch-zoom"), P(this._map._container, "touchstart", this._onTouchStart, this);
        },
        removeHooks: function() {
        ...
        _onTouchMove: function(t) {
          if (!(!t.touches || t.touches.length !== 2 || !this._zooming)) {
            ...
            this._moved || (e._moveStart(true, false), this._moved = true), D(this._animRequest);
            var r = v2(e._move, e, this._center, this._zoom, { pinch: true, round: false }, void 0);
            this._animRequest = Z(r, this, true), G(t);
          }
        },
        _onTouchEnd: function() {
          ...
          this._zooming = false, D(this._animRequest), O(document, "touchmove", this._onTouchMove, this), O(document, "touchend touchcancel", this._onTouchEnd, this), this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), true, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom));
        }
      });
      M.addInitHook("addHandler", "touchZoom", Cn), M.BoxZoom = wn, M.DoubleClickZoom = xn, M.Drag = Pn, M.Keyboard = Ln, M.ScrollWheelZoom = bn, M.TapHold = Tn, M.TouchZoom = Cn, u.Bounds = A, u.Browser = m, u.CRS = ct, u.Canvas = pn, u.Circle = hi, u.CircleMarker = ve, u.Class = q, u.Control = ot, u.DivIcon = dn, u.DivOverlay = lt, u.DomEvent = go, u.DomUtil = mo, u.Draggable = wt, u.Evented = Gt, u.FeatureGroup = ft, u.GeoJSON = _t, u.GridLayer = ne, u.Handler = ut, u.Icon = Bt, u.ImageOverlay = Le, u.LatLng = z, u.LatLngBounds = X, u.Layer = st, u.LayerGroup = At, u.LineUtil = zo, u.Map = M, u.Marker = ge, u.Mixin = bo, u.Path = xt, u.Point = x, u.PolyUtil = To, u.Polygon = Rt, u.Polyline = dt, u.Popup = be, u.PosAnimation = Ki, u.Projection = Eo, u.Rectangle = yn, u.Renderer = mt, u.SVG = se, u.SVGOverlay = fn, u.TileLayer = Dt, u.Tooltip = Te, u.Transformation = Ie, u.Util = vt, u.VideoOverlay = cn, u.bind = v2, u.bounds = Y, u.canvas = gn, u.circle = Do, u.circleMarker = No, u.control = te, u.divIcon = Ko, u.extend = d, u.featureGroup = Ao, u.geoJSON = ln, u.geoJson = Wo, u.gridLayer = Yo, u.icon = Bo, u.imageOverlay = Vo, u.latLng = C, u.latLngBounds = F, u.layerGroup = Io, u.map = vo, u.marker = Ro, u.point = w, u.polygon = Fo, u.polyline = Ho, u.popup = qo, u.rectangle = $o, u.setOptions = E, u.stamp = g, u.svg = vn, u.svgOverlay = Go, u.tileLayer = _n, u.tooltip = jo, u.transformation = qt, u.version = p, u.videoOverlay = Uo;
      var ts = window.L;
...
var On = vs();
const Se = /* @__PURE__ */ rB(On);
function Zn(f, _) {
  const u = reactExports.useRef(_);
  reactExports.useEffect(function() {
    _ !== u.current && f.attributionControl != null && (u.current != null && f.attributionControl.removeAttribution(u.current), _ != null && f.attributionControl.addAttribution(_)), u.current = _;
  }, [
    f,
    _
  ]);
...
const In = reactExports.createContext(null), ws = In.Provider;
function ke() {
  const f = reactExports.useContext(In);
  if (f == null)
...
function An(f) {
  function _(u, p) {
    const { instance: d, context: k } = f(u).current;
    return reactExports.useImperativeHandle(p, () => d), u.children == null ? null : /* @__PURE__ */ nt.createElement(ws, {
      value: k
    }, u.children);
  }
  return /* @__PURE__ */ reactExports.forwardRef(_);
}
function xs(f) {
  function _(u, p) {
    const [d, k] = reactExports.useState(false), { instance: v2 } = f(u, k).current;
    reactExports.useImperativeHandle(p, () => v2), reactExports.useEffect(function() {
      d && v2.update();
    }, [
      v2,
      d,
    ...
    const R = v2._contentNode;
    return R ? /* @__PURE__ */ reactDomExports.createPortal(u.children, R) : null;
  }
  return /* @__PURE__ */ reactExports.forwardRef(_);
}
function Ps(f) {
  function _(u, p) {
    const { instance: d } = f(u).current;
    return reactExports.useImperativeHandle(p, () => d), null;
  }
  return /* @__PURE__ */ reactExports.forwardRef(_);
}
function pi(f, _) {
  ...
  reactExports.useEffect(function() {
    return _ != null && f.instance.on(_), u.current = _, function() {
      u.current != null && f.instance.off(u.current), u.current = null;
    };
  }, [
    f,
    _
...
function Ls(f, _) {
  return function(p, d) {
    const k = ke(), v2 = f(gi(p, k), k);
    return Zn(k.map, p.attribution), pi(v2.current, p.eventHandlers), _(v2.current, k, p, d), v2;
  };
}
function bs(f, _, u) {
  return Object.freeze({
...
function ze(f, _) {
  return _ == null ? function(p, d) {
    const k = reactExports.useRef();
    return k.current || (k.current = f(p, d)), k;
  } : function(p, d) {
    const k = reactExports.useRef();
    k.current || (k.current = f(p, d));
    const v2 = reactExports.useRef(p), { instance: R } = k.current;
    return reactExports.useEffect(function() {
      v2.current !== p && (_(R, p, v2.current), v2.current = p);
    }, [
      R,
      p,
      d
...
function Bn(f, _) {
  reactExports.useEffect(function() {
    return (_.layerContainer ?? _.map).addLayer(f.instance), function() {
      var k;
      (k = _.layerContainer) == null || k.removeLayer(f.instance), _.map.removeLayer(f.instance);
    };
  }, [
    _,
    f
...
function Rn(f) {
  return function(u) {
    const p = ke(), d = f(gi(u, p), p);
    return Zn(p.map, u.attribution), pi(d.current, u.eventHandlers), Bn(d.current, p), d;
  };
}
function Ts(f, _) {
  const u = reactExports.useRef();
  reactExports.useEffect(function() {
    if (_.pathOptions !== u.current) {
      const d = _.pathOptions ?? {};
      f.instance.setStyle(d), u.current = d;
    }
  }, [
    f,
    _
...
function Cs(f) {
  return function(u) {
    const p = ke(), d = f(gi(u, p), p);
    return pi(d.current, u.eventHandlers), Bn(d.current, p), Ts(d.current, u), d;
  };
}
function Fs(f, _) {
  const u = ze(f, _), p = Rn(u);
  return An(p);
}
function Ms(f, _) {
  const u = ze(f), p = Ls(u, _);
  return xs(p);
}
function Ws(f, _) {
  const u = ze(f, _), p = Cs(u);
  return An(p);
}
function Vs(f, _) {
  const u = ze(f, _), p = Rn(u);
...
const ks = Ms(function(_, u) {
  const p = new On.Tooltip(_, u.overlayContainer);
  return bs(p, u);
}, function(_, u, { position: p }, d) {
  reactExports.useEffect(function() {
    const v2 = u.overlayContainer;
    if (v2 == null)
      return;
    const { instance: R } = _, g = (tt) => {
      tt.tooltip === R && (p != null && R.setLatLng(p), R.update(), d(true));
    }, Pt = (tt) => {
      tt.tooltip === R && d(false);
    };
    return v2.on({
      tooltipopen: g,
      tooltipclose: Pt
    }), v2.bindTooltip(R), function() {
      v2.off({
        tooltipopen: g,
        tooltipclose: Pt
      }), v2._map != null && v2.unbindTooltip();
    };
  }, [
    _,
    u,
...
}), En = { height: "100%", minHeight: "100px" }, zs = (f) => {
  const { markers: _ } = f, u = Ss();
  if (!_ || _.length === 0) return null;
  const p = _.reduce(
    (d, k) => {
      const { lat: v2, lng: R } = k;
      return [
        [Math.min(d[0][0], v2), Math.min(d[0][1], R)],
        [Math.max(d[1][0], v2), Math.max(d[1][1], R)]
      ];
    },
    [
      [1 / 0, 1 / 0],
  ...
  const {
    ...
    customTileSet: p,
    ds: d,
    markerClusterColor: k,
    markerColor: v2,
    metric: R,
    results: g,
    showTooltips: Pt
  } = f, [tt, I] = reactExports.useState(0);
  reactExports.useEffect(() => {
    I((N) => N + 1);
  }, [f]);
  const K = [], St = ((zt = g == null ? void 0 : g.data) == null ? void 0 : zt.length) || 0;
  if (St > 0)
    for (let N = 0; N < St; N++) {
      const Z = ((Vt = g == null ? void 0 : g.data) == null ? void 0 : Vt[N][_.name].split(",")[0]) || 0, D = ((Ut = g == null ? void 0 : g.data) == null ? void 0 : Ut[N][_.name].split(",")[1]) || 0, vt = (Et = g == null ? void 0 : g.data) == null ? void 0 : Et[N][(R == null ? void 0 : R.name) || ""], q = R, Oe = (q == null ? void 0 : q.modelTitle) || "";
      K.push({
        title: Oe,
        count: vt,
        lat: Z,
  ...
  const [rt, E] = reactExports.useState(null);
  if (reactExports.useEffect(() => {
    (async () => {
      const { MapContainer: Z, Marker: D, TileLayer: vt } = await import('./index-DyUIdp01-DJNOpuWG-1YrDbLbc.js'), q = await import('./index-D3rp6o_m-o3CTjsl9-f-OdASDK.js');
      E({ MapContainer: Z, Marker: D, TileLayer: vt, MarkerClusterGroup: q.default });
    })();
  }, []), !rt) return /* @__PURE__ */ j.jsx("div", { children: "Loading map..." });
  const ae = function(N) {
    const Z = N.getChildCount() < 10 ? 18 : Math.ceil(18 * (N.getChildCount().toString().length * 0.66)), D = Math.floor(Z / 2);
    return Se.divIcon({
      html: `<span style="display: flex; width: ${Z}px; height: ${Z}px; background-color:${k}; border-radius: ${D}px; color: #ffffff; align-items: center; justify-content: center;">${N.getChildCount()}</span>`,
      className: "custom-marker-cluster",
      iconSize: Se.point(33, 33, true)
    });
  }, Ee = function() {
    return Se.divIcon({
      html: `<span style="display: flex; width: 10px; height: 10px; background-color:${v2}; border-radius: 5px; color: #ffffff; align-items: center; justify-content: center;">&nbsp;</span>`,
      className: "custom-marker",
      iconSize: Se.point(10, 10, true)
    });
  }, { MapContainer: he, Marker: $, TileLayer: Wt, MarkerClusterGroup: kt } = rt;
  return /* @__PURE__ */ j.jsx(Wg, { ...f, className: "overflow-y-hidden", children: /* @__PURE__ */ j.jsx("div", { style: En, children: /* @__PURE__ */ j.jsxs(he, { attributionControl: false, maxZoom: 16, style: En, zoom: 14, children: [
    /* @__PURE__ */ j.jsx(
      Wt,
      {
        url: p || "https://{s}.tile.osm.org/{z}/{x}/{y}.png",
        attribution: ""
      }
    ),
    /* @__PURE__ */ j.jsx(zs, { markers: K }),
    /* @__PURE__ */ j.jsx(
      kt,
      {
        iconCreateFunction: ae,
        maxClusterRadius: u,
        onClick: (N) => console.log("onClick", N),
        removeOutsideVisibleBounds: true,
        showCoverageOnHover: false,
        spiderfyOnMaxZoom: true,
        children: K.map((N, Z) => {
          const D = N.lat, vt = N.lng;
          return /* @__PURE__ */ j.jsx(
            $,
            {
              ...
              position: [D, vt],
              title: "",
              children: Pt && /* @__PURE__ */ j.jsxs(ks, { children: [
                N.title,
                ": ",
                N.count
              ] })
  ...
  inputs: [
    ...
    },
    {
      ...
      description: "Radius within which markers are clustered. Larger value = fewer clusters with more items - REQUIRES REFRESH",
      defaultValue: 20,
      category: "Chart Settings"
    },
    {
...
}, Us = defineComponent(Es, Os, {
  props: (f) => ({
    ...f,
    results: v({
      from: f.ds,
      limit: 5e3,
      select: [f.bubblePlacement, f.metric]
    })
  })
});
const BubbleMapChart = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Us,
  meta: Os
}, Symbol.toStringTag, { value: "Module" }));

export { BubbleMapChart as B, Ds as D, Fs as F, Hs as H, On as O, Ss as S, Vs as V, Ws as W, Se as a, bs as b, gi as g, ks as k, ws as w };
//# sourceMappingURL=BubbleMapChart-DoY9i-C0-IXyn4XOg.js.map
