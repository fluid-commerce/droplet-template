import { d as defineComponent, l as loadData } from './index.esm-CVE60fla-BtsXn2z1.js';
import { j as jsxRuntimeExports, r as reactExports, n as nt } from './embeddable-component-BD9bezsm.js';
...
var plugin_colors = {
  ...
  beforeLayout(chart, _args, options) {
    ...
    const { data: { datasets }, options: chartOptions2 } = chart.config;
    const { elements: elements2 } = chartOptions2;
    const containsColorDefenition = containsColorsDefinitions(datasets) || containsColorsDefinition(chartOptions2) || elements2 && containsColorsDefinitions(elements2) || containsDefaultColorsDefenitions();
...
const Spinner = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: `
      ...
      ` }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: loaderStyle })
] });
const Error$1 = (props) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: "red" }, children: [
  "Error: ",
  props.msg
] });
...
function ChartComponent(props, ref) {
  ...
  return /* @__PURE__ */ nt.createElement("canvas", {
    ref: canvasRef,
    role: "img",
    height,
    width,
...
function createTypedChart(type, registerables2) {
  ...
  return /* @__PURE__ */ reactExports.forwardRef((props, ref) => /* @__PURE__ */ nt.createElement(Chart, {
    ...props,
    ref,
    type
  }));
...
const Component = (props) => {
  ...
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Error$1, { msg: error });
  }
  const labels = data == null ? void 0 : data.map((d) => d[slice.name]);
  const counts = data == null ? void 0 : data.map((d) => d[metric.name]);
...
const ExamplePieChart_emb = defineComponent(Component, meta, {
  props: (inputs) => {
    return {
      ...inputs,
      results: loadData({
...
export { ExamplePieChart_emb as default, meta };
//# sourceMappingURL=ExamplePieChart.emb-By-ELyhu-WC3Qsk45.js.map
//# sourceMappingURL=ExamplePieChart.emb-By-ELyhu-WC3Qsk45.js.map
